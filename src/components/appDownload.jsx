        ...
        <Grid container justify="center" alignItems="center" className={sty.root}        >
            <Grid container alignItems="center" justify='center' className={sty.container}>
                ...
                <Grid item sm={6} xs={12} style={{ textAlign: 'left', margin: '0 auto' }}>
                    ...
                    <br />
                    <br />
                    <a href='https://play.google.com/store/apps/details?id=in.roomlelo&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'><img height='60px' alt='Get it on Google Play' src='https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png' /></a>
